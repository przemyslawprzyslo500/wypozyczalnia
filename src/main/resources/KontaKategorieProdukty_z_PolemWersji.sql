...
INSERT INTO WYPOZYCZALNIA.EQUIPMENT (ID, LICENSE_ID, NAME, RENT_PERMISION, TYPE, EQUIPMENT_STATUS_ID, LICENSE_TYPE_ID, RESERVATION_RESERVATION_ID, USE_PLACE_ID) 
VALUES (1, 1, 'Komputer', 't', 'stacjonarny','', 1, 1);
