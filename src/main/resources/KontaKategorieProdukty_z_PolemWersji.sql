...
INSERT INTO WYPOZYCZALNIA.EQUIPMENT (ID, LICENSE_ID, NAME, RENT_PERMISION, STATUS, TYPE, USE_PLACE, EQUIPMENT_STATUS_ID, LICENSE_TYPE_ID, RESERVATION_RESERVATION_ID, USE_PLACE_ID) 
VALUES (1, 'PRACOWNIK', 1, 'hasprac', 'prac', 1, 1);
